        ...
        <div class="card bg-danger img-card box-primary-shadow">
         <div class="card-body">
          <div class="d-flex">
           ...
           <div class="ml-auto"> <img src="{{asset('assets2/img/sad-u6e.png')}}" width="50" height="50" alt="Positif"> </div>
          </div>
         </div>
        </div>
       </div><!-- COL END -->
        ...
        <div class="card bg-success img-card box-secondary-shadow">
         <div class="card-body">
          <div class="d-flex">
           ...
           <div class="ml-auto"> <img src="{{asset('assets2/img/happy-ipM.png')}}" width="50" height="50" alt="Positif"> </div>
          </div>
         </div>
        </div>
       </div><!-- COL END -->
        ...
        <div class="card  bg-secondary img-card box-success-shadow">
         <div class="card-body">
          <div class="d-flex">
           ...
           <div class="ml-auto"> <img src="{{asset('assets2/img/emoji-LWx.png')}}" width="50" height="50" alt="Positif"> </div>
          </div>
         </div>
        </div>
       </div><!-- COL END -->
        ...
        <div class="card  bg-info img-card box-success-shadow">
         <div class="card-body">
          <div class="d-flex">
           ...
           <div class="ml-auto"> <img src="{{asset('assets2/img/indonesia-PZq.png')}}" width="50" height="50" alt="Positif"> </div>
          </div>
         </div>
        </div>
       </div><!-- COL END -->
    ...
    <section id="gallery" class="gallery">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Gallery</h2>
          <p>Menjaga ke sehatan Dan Kebersihan Itu Penting, Maka Dari Itu Jaga Lah Ke sehatan Dan Juga Kebersihan Untuk Masa Masa Yang lebih Berwarna!</p>
        </div>
      </div>
